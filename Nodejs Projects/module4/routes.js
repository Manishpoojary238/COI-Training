...
const requestHandler = (req, res) => {
    ...
    if(url === '/message' && method === 'POST'){
        ...
        return req.on('end', () => {
            ...
            const message = parsedBody.split('=')[1];   //now praseBody will be in the key value pair. we want only value. so we are splitting. after splitting index [0]->key and index[1]->value.
